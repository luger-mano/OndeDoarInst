...
export default function App() {
  ...
  useEffect(() => {
    ...
    fetch(
      "44.209.168.250:8080/centers/filter/zone/neighborhoods"
    )
        ...
        try {
          ...
          const response =
            await fetch(
              ...
              `http://44.209.168.250:8080/centers/filter/search?search=${encodeURIComponent(query)}`
